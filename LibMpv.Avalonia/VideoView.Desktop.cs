...
public class VideoView : OpenGlControlBase, IMpvVideoView
{
    ...
    {
        Console.WriteLine("DetachMpvContext");
        context.StopRendering();
        Console.WriteLine("DetachMpvContext1");
    ...
    private void AttachMpvContext(MpvContext context)
    {
        ...
        {
            mpvContext?.ConfigureRenderer(new OpenGlRendererConfiguration()
                { OpnGlGetProcAddress = getProcAddres, UpdateCallback = this.UpdateVideoView });
        }
    }
