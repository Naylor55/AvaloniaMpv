...
public static unsafe partial class LibMpv
{
    ...
    public static int MpvRenderContextCreate(MpvRenderContext** @res, MpvHandle* @mpv, MpvRenderParam* @params)
    {
        Console.WriteLine($"MpvRenderContextCreate {(int)@res} {(int)@mpv} {(int)@params}");
